...
<body>
  ...
  <script>
    ...
    <div><img src="https://mc.yandex.ru/watch/55062736" style="position:absolute; left:-9999px;" alt="" /></div>
    ...
    <div class="container">
      <nav class="menu">
        ...
        <ul class="menu__links">
          <li class="menu__item"><a href="сatalog.php" target="_blank">Каталог </a>
            ...
            <ul class="submenu submenu_one">
              ...
              <li class="submenu-category">
                ...
                <ul class="submenu-category__list">
                  ...
                  <li class="submenu-category__item"><a href="#" class="submenu-category__link">Журнальные столы</a>
                  </li>
              ...
              <li class="submenu-category">
                ...
                <ul class="submenu-category__list">
                  ...
                  <li class="submenu-category__item"><a href="#" class="submenu-category__link">Тумбы прикроватные</a>
                  </li>
                  <li class="submenu-category__item"><a href="#" class="submenu-category__link">Туалетные столики</a>
                  </li>
              ...
              <li class="submenu-category">
                ...
                <ul class="submenu-category__list">
                  <li class="submenu-category__item"><a href="#" class="submenu-category__link">Письменные столы</a>
                  </li>
                  <li class="submenu-category__item"><a href="#" class="submenu-category__link">Компьютерные столы</a>
                  </li>
